...
public class UC05CadastrarConvenio {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		convenioDAO.adiciona(convenio);
		convenio = new Convenio("81965361000174", "21/05/2016", "04/05/2016");
		convenioDAO.adiciona(convenio);
		convenio = new Convenio("81965361000174", "05/06/2016", "30/05/2016");
		convenioDAO.adiciona(convenio);
	...
	public void CT06UC05A3cadsatrar_cnpj_invalido(){
		cnpj = "11111";
